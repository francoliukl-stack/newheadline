...
**审计时间：** 2026-06-29 07:00（Asia/Kuala_Lumpur）  
...
| 自动化回归 | 已验证 | 115 个单测通过；v3.1 golden 指标全部通过；cutover dry-run=`ready`。 |

## 运营目标证据

| 指标 | 目标 | 当前证据 | 判定 |
| --- | ---: | ---: | --- |
| 高相关外部信号 | 10–30 / 周 | 9 | 尚未达下限 |
| Event Case | 5–10 / 周 | 8 | 达标，观察期不足 |
| 关键事件上线后当日/次日感知 | 100% | 暂无上线后样本；3 个上线前回填已单列 | 无数据 |
| 业务线映射完整率 | 100% | 1.0 | 当前达标 |
| 明确 Event Type 覆盖率 | 目标持续提升 | 0.625 | 需要继续校准，不能用静态准确率替代 |
| 候选/已采纳追溯率 | 100% | 1.0 / 1.0 | 当前达标 |
| 自动最终 P0 违规 | 0 | 0 | 当前达标 |
| API 成本 | <=25 USD/月 | 0 USD / 最近 28 天 | 当前达标 |
| Deep Research Ready Event | 按人工批准产生 | 0 | 尚无批准样本 |
| 四周稳定运行 | 28 天 | 第 2 天 | `observation_incomplete` |
