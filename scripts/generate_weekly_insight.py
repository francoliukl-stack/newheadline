...
run_id = run_logs.start("generate_weekly_insight", provider="subscription_carrier", metadata={"days": args.days})
...
try:
    ...
    if research_queue.get("id"):
        ...
        patch = {
            ...
            **build_research_input_fields(records, now.isoformat(timespec="seconds")),
        }
